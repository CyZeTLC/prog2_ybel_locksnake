        ...
        SwingUtilities.invokeLater(
                () -> {
                    try {
                        ...
                        engine.getObservers().add(panel);
                        panel.getObservers().add(engine);
                        ...
                        JOptionPane.showMessageDialog(
                                null, "Fehler beim Starten des Spiels: " + e.getMessage(), "Fehler", JOptionPane.ERROR_MESSAGE);
                    }
                });
    }
